...
from .isaaclab_scene_marl_env_cfg import IsaaclabSceneMarlEnvCfg


class IsaaclabSceneMarlEnv(DirectMARLEnv):
    cfg: IsaaclabSceneMarlEnvCfg

    def __init__(self, cfg: IsaaclabSceneMarlEnvCfg, render_mode: str | None = None, **kwargs):
