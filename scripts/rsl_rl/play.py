...
parser.add_argument("--speed_factor", type=float, default=1.0, help="Multiply agent actions for faster movement.")
...
''' original  code '''
    ...
    # play_time_s = 30.0
    # max_steps = int(play_time_s / dt)

    # action_repeat = 10   # hold same action for 10 steps
    # last_actions = None
    ...
    #             # env stepping
    #         obs, _, dones, _ = env.step(last_actions)
